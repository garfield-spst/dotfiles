...
alias hp="hyprpm"
alias nn="nnn -p"
alias scam="sudo modprobe -v v4l2loopback exclusive_caps=1 card_label='S23 Webcam'"
alias camb="scrcpy --video-source=camera --no-audio --camera-facing=back --orientation=flip270 --v4l2-sink=/dev/video0"
alias camf="scrcpy --video-source=camera --no-audio --camera-facing=front --orientation=flip0 --v4l2-sink=/dev/video0"
